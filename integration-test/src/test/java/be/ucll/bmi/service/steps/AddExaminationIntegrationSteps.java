...
public class AddExaminationIntegrationSteps extends IntegrationSteps {
    ...
    public void martha_registers_the_future_date_as_the_examination_date(LocalDate date) {
...
//adds the number of days to the examinationDate parameter, the ‘future date’
        LocalDate futureExaminationDate = context.getExamination().getExaminationDate();
